...
public class APIWorkflowSteps {
    ...
    public void a_request_is_prepared_to_create_an_employee_with_dynamic_data(String fName, String lName, String mName, String gender, String birthday, String emp_status, String jobTitle) {

        request = given().header(APIConstants.HEADER_KEY_CONTENT_TYPE, APIConstants.HEADER_VALUE_CONTENT_TYPE).
                header(APIConstants.HEADER_KEY_AUTHORIZATION, GenerateTokenSteps.token).
                body(APIPayloadConstants.createEmployeePayloadDynamic(fName, lName, mName, gender, birthday, emp_status, jobTitle));
    }
